<style>
  ...
  /* Services timeline: image height + spacing tighter on small phones */
  @media (max-width: 480px) {
    .lt-tl-img-wrap { height: 200px !important; }
    .lt-tl-title { font-size: 1.05rem !important; }
    .lt-tl-desc  { font-size: .88rem !important; }
    .lt-tl-step  { margin-bottom: 38px !important; }
  }
  ...
  /* Markets country cards on mobile: image gets a friendlier height */
  @media (max-width: 768px) {
    .lt-mkt-img, .lt-mkt-featured .lt-mkt-img { min-height: 200px !important; }
  }
  @media (max-width: 480px) {
    .lt-mkt-img, .lt-mkt-featured .lt-mkt-img { min-height: 170px !important; }
    .lt-mkt-body, .lt-mkt-featured .lt-mkt-body { padding: 20px 18px !important; }
    .lt-mkt-row { margin-bottom: 40px !important; }
    .lt-mkt-row h3 { font-size: 1.35rem !important; }
  }
