...
$page = [
    'title' => 'Request a Wholesale Quote | Leen Trade B2B Quotation',
    'desc'  => 'Request a B2B wholesale quotation from Leen Trade Co. Container loads, recurring supply, export enquiries — pricing within 24 hours.',
    'kw'    => 'wholesale quote Lebanon, B2B quotation packaging, container load Lebanon',
    'slug'  => '/request-quote',
];
$lp = $LANG === 'ar' ? '?lang=ar' : '';
...
<section class="lt-page-header" style="position:relative;background:linear-gradient(135deg,#0a2540 0%,#1a3554 100%);color:#fff;padding:80px 40px;overflow:hidden">
  ...
  <div style="max-width:1200px;margin:0 auto;position:relative;z-index:1">
    <nav aria-label="Breadcrumb" style="font-size:.78rem;color:#94a3b8;margin-bottom:20px">
      <a href="index.php<?= $lp ?>" style="color:#94a3b8;text-decoration:none" data-i18n="nav.home"><?= t('nav.home') ?></a> <span style="margin:0 8px;color:#c9a25f">/</span> <span style="color:#fff" data-i18n="page.rfq.crumb"><?= t('page.rfq.crumb') ?></span>
    </nav>
    <div class="lt-eyebrow" style="color:#c9a25f" data-i18n="page.rfq.crumb"><?= t('page.rfq.crumb') ?></div>
    <h1 style="font-size:2.6rem;font-weight:800;line-height:1.15;margin:0 0 18px 0;color:#fff;letter-spacing:-.02em;max-width:780px" data-i18n="page.rfq.h1"><?= t('page.rfq.h1') ?></h1>
    <p style="color:#cbd5e1;font-size:1.02rem;line-height:1.7;margin:0;max-width:680px;font-weight:400" data-i18n="page.rfq.intro"><?= t('page.rfq.intro') ?></p>
  </div>
</section>
